...
def vtm_decode_only(org_feat_path, root_path, codec, model_type, task, source_file, quant_type, samples, bit_depth, QP):
    # Set related paths
    ...
    for idx, feat_name in enumerate(feat_names):
        ...
        # VTM decoding
        vtm_decoding(bitstream_name, decoded_yuv_name, decoding_log_name, bit_depth)
...
if __name__ == "__main__":
    ...
    for QP in QPs:
        ...
        print(model_type, task, trun_flag, quant_type, samples, max_v, min_v, bit_depth, QP)
        vtm_decode_only(org_feat_path, root_path, codec, model_type, task, source_file, quant_type, samples, bit_depth, QP)