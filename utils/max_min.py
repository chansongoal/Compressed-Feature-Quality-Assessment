...
def compute_statistics(directory, channel):
    max_values = []
    min_values = []
    mean_values = []
...
if __name__ == "__main__":
    directory = "/gdata1/gaocs/FCM_LM_Test_Dataset/dinov2/cls/feature"  # Replace with your directory path
    channel = 0
    compute_statistics(directory, channel)
